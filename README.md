...
* [📊 Diagrama de Flux de Control](#-diagrama-de-flux-de-control)
* [🚀 Com utilitzar](#-com-utilitzar)

  * [1️⃣ Requisits previs](#1️⃣-requisits-previs)
  * [2️⃣ Connexió amb la Flight Controller (FC)](#2️⃣-connexió-amb-la-flight-controller-fc)
  * [3️⃣ Execució d’un script de vol](#3️⃣-execució-dun-script-de-vol)
  * [4️⃣ Altres scripts úutils](#4️⃣-altres-scripts-úutils)
* [🧰 Estructura del projecte](#-estructura-del-projecte)
* [📬 Contacte i crèdits](#-contacte-i-crèdits)
...
Creat per \[El teu nom o equip], 2025. Basat en MAVLink, pymavlink i ArduPilot.
